<template>
  <div class="w-full h-full flex flex-col">
    <div class="flex h-[150px] items-center">
      <CarrierCountStatistics></CarrierCountStatistics>
    </div>

    <div class="flex-1">
      <TheSingleDoor v-if="isSingleDoor"></TheSingleDoor>
      <TheMultiDoor v-else></TheMultiDoor>
    </div>
  </div>
</template>
...
<style scoped>
.statistics-wrap {
  @apply flex h-[160px] items-center gap-16;
}
.statistics-count {
...
.statistics-count span:nth-child(1) {
  @apply text-gray-2 font-['Barlow'] text-[80px];
}
