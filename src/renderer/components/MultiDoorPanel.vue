...
const { cabinetDoorList, carrierList, isLockControlConnected } =
  storeToRefs(store);
...
<template>
  <div class="relative flex h-full items-center justify-center">
    <!-- 操作栏 -->
    <div
      class="absolute top-[10px] right-[10px] flex select-none items-center text-white"
    >
    ...
    <div class="grid h-[460px] w-[700px] grid-flow-col grid-rows-4 gap-[4px]">
      ...
      >
        <div class="relative flex flex-1 items-center justify-center">
          ...
          <div
            class="mt-2 flex select-none flex-col items-center justify-center text-sm"
          >
            <p>{{ door.name }}</p>
