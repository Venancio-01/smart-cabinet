...
<template>
  <div
    class="rounded-[14px] bg-[rgba(255,255,255,0.15)] grid gap-4 h-full"
    :class="[layoutClassMap[layout], sizeClassMap[size]]"
  >
    <div
      v-for="(item, index) in data"
      :key="index"
      class="text-light text-xl flex-col justify-center"
    >
      <div class="mb-4">
        {{ item.name }}
      </div>
