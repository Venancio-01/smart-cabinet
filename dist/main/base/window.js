...
var preload = (0, _path.join)(__dirname, "./preload.js");
var url = "http://localhost:4200/";
var indexHtml = (0, _path.join)(__dirname, "../../renderer/index.html");
function createWindow() {
    return _createWindow.apply(this, arguments);
}
function _createWindow() {
    _createWindow = _async_to_generator(function() {
        var win;
        return _ts_generator(this, function(_state) {
            win = new _electron.BrowserWindow(_object_spread_props(_object_spread({}, _config.WINDOW_SIZE), {
                title: "智能载体管控系统",
            ...
            win.webContents.setWindowOpenHandler(function(param) {
                var url = param.url;
