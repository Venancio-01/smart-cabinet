...
function _connectToDatabase() {
    _connectToDatabase = _async_to_generator(function() {
        var e;
...
function disconnectFromDatabase() {
    return _disconnectFromDatabase.apply(this, arguments);
}
function _disconnectFromDatabase() {
    _disconnectFromDatabase = _async_to_generator(function() {
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
